...
## Предосторежения
> ⚠️ <b>ВНИМАНИЕ!</b>  
Я не призываю никого скачивать данный клиент и заводить аккаунт в Max, как альтернативу Telegram (который по умолчанию не является Spyware). Делайте это только в крайнем случае, когда активны белые списки или хочется поэксперементировать. <b>Не сдавайтесь!</b>
...
<b>Небольшой размер приложения достигается использованием встроенного веб-браузера (спасибо команде Tauri!)</b>
...
```
Для всех платформ Android сразу (увеличится размер .apk)
```sh
