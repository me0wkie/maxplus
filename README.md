...
## Предосторежения
> ⚠️ <b>ВНИМАНИЕ!</b>  
Я не призываю никого скачивать данный клиент и заводить аккаунт в Max <b>как альтернативу Telegram</b> (который по умолчанию не является Spyware). Делайте это только в крайнем случае, когда активны белые списки или хочется поэксперементировать.
